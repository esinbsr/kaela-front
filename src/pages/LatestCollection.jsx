  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore the latest trends and new arrivals at Kaela Couture. Our new fashion collections blend modern style with high-quality craftsmanship."
        />
      </Helmet>
      <main className="evening-latest">
        ...
        <EveningLatestImageList
          ...
          section={SECTIONS.LATEST_COLLECTION}
        />
      </main>
      <Footer />
    </>
