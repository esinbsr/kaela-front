...
// Component to display information details in a table row
    ...
    <tr>
      ...
      <td data-label="Action">
        <div className="button-group">
          <Link
            to={`/updateInformation/${infos.id}`}
            className="blue-link"
            aria-label={`Update information ${infos.description}`}
          >
            Update
          </Link>
          <DeleteInformation
            informationId={infos.id}
            informationDescription={infos.description}
          />
        </div>
      </td>
    </tr>
