import {
  ADD_SOCIAL_NETWORK_ERROR,
  ADD_SOCIAL_NETWORK_SUCCESS,
  DELETE_SOCIAL_NETWORK_ERROR,
  DELETE_SOCIAL_NETWORK_SUCCESS,
  GET_SOCIAL_NETWORK_BY_ID_ERROR,
  GET_SOCIAL_NETWORK_BY_ID_SUCCESS,
...
const socialNetworkReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case UPDATE_SOCIAL_NETWORK_SUCCESS:
      return {
        ...
        socialNetwork: state.socialNetwork.map((socialNetwork) =>
          socialNetwork.id === action.payload.id
            ? action.payload
            : socialNetwork
        ),
        message: action.message,
    ...
    case DELETE_SOCIAL_NETWORK_SUCCESS:
      return {
        ...state,
        socialNetwork: state.socialNetwork.filter(
          (socialNetwork) => socialNetwork.id !== action.payload
        ),
        message: action.message,
        error: "",
      };
